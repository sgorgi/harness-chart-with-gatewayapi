...
{{/*
Orchestration engine selector labels
*/}}
{{- define "orchestration-engine.selectorLabels" -}}
app.kubernetes.io/name: orchestration-engine
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{/*
Orchestration engine labels
*/}}
{{- define "orchestration-engine.labels" -}}
helm.sh/chart: {{ include "pipeline-service.chart" . }}
{{ include "orchestration-engine.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
