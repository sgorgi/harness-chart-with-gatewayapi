...
![Version: 0.8.2](https://img.shields.io/badge/Version-0.8.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.4.7-alpine](https://img.shields.io/badge/AppVersion-7.4.1--alpine-informational?style=flat-square)
...
| initContainers.config_init.image.tag | string | `"7.4.7-alpine"` |  |
...
| redis.image.tag | string | `"7.4.7-alpine"` |  |
...
| sentinel.image.tag | string | `"7.4.7-alpine"` |  |
